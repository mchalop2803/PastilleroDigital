...
public class ListMedicamentActivity extends AppCompatActivity {
    ...
    private TextView tvMedicamentoTitle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvMedicamentoTitle.setText("Mis medicamentos");

        loadMedicamentos();

        lvMedicament.setOnItemClickListener(
                new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(
                        ...
                        Medicamento medicamento =
                                medicamentos.get(position);

                        Intent intent =
                                new Intent(
                                        ListMedicamentActivity.this,
                                        DetailsMedicamentActivity.class
                                );
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(
                        ...
                        if (medicamentAdapter == null) {
                            ...
                            medicamentAdapter =
                                    new MedicamentAdapter(
                                            ListMedicamentActivity.this,
                                            medicamentos
                                    );

                            lvMedicament.setAdapter(
                                    medicamentAdapter
                            );
    ...
    private void loadComponents() {
        ...
        lvMedicament =
                findViewById(R.id.lvMedicament);

        imageButton =
                findViewById(R.id.imageButton);

        fltBtnAddMedicament =
                findViewById(R.id.fltBtnAddMedicament);

        tvMedicamentoTitle =
                findViewById(R.id.tvMedicamentoTitle);
